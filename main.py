...
import ui_resources
from gmlist_ui import Ui_MainWindow
...
class GmList(Ui_MainWindow, QMainWindow):
    ...
    from task_handler import addTask
    from task_handler import removeTask
    from task_handler import markTaskAsDone
    from task_handler import markTaskAsPending
    from task_handler import selectAllTasks
    from task_handler import applyFilters
    from task_handler import updateDuration
    from task_handler import updateSummary
    
    from save_load import saveToDoList
    from save_load import save_tasks_to_file
    from save_load import loadToDoList
    from save_load import load_tasks_from_file
    from save_load import newToDoList

    from notification_timer import checkForNotifications
    from notification_timer import setEnabledDisabledSoundButton
    from notification_timer import setIconSoundButton
    
    from move_task import moveDownTask
    from move_task import moveUpTask
    from move_task import connectDurationSignals

    from sort_table import sortTable
    from sort_table import sortByTime
    from sort_table import reorderTable
    from sort_table import sortByDuration
    
    from about_program_handler import openAboutProgramDialog_Handler
    from about_program_handler import closeAboutProgramDialog_Handler
    ...
    def __init__(self  ,  appXX):
        ...
        self.notification_sound.setSource(QUrl.fromLocalFile(":/ring_sound_effect.wav"))
        ...
        self.aboutButton.clicked.connect(self.openAboutProgramDialog_Handler)
